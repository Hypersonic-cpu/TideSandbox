...
class MPSGraphAutomaticBackend final {
public:
    MPSGraphAutomaticBackend();
    ~MPSGraphAutomaticBackend();
    MPSGraphAutomaticBackend(MPSGraphAutomaticBackend&&) noexcept;
    MPSGraphAutomaticBackend& operator=(MPSGraphAutomaticBackend&&) noexcept;

    MPSGraphAutomaticBackend(const MPSGraphAutomaticBackend&) = delete;
    MPSGraphAutomaticBackend& operator=(const MPSGraphAutomaticBackend&) = delete;
